...
// Use the Radix Root directly (it doesn't accept a DOM ref). Wrapping with
// forwardRef can cause type/ref issues because Root is not a DOM element.
...
// Radix Portal does not accept a DOM ref prop; implement as a plain component
